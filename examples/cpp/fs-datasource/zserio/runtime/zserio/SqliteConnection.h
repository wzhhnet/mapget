...
public:
     ...
     */
    void executeUpdate(std::string_view sqlQuery);
     ...
     */
    sqlite3_stmt* prepareStatement(std::string_view sqlQuery);
...
inline void SqliteConnection::executeUpdate(std::string_view sqlQuery)
{
...
inline sqlite3_stmt* SqliteConnection::prepareStatement(std::string_view sqlQuery)
{
