...
public:
     ...
     */
    virtual bool reportError(std::string_view tableName, std::string_view fieldName,
            Span<const std::string_view> primaryKeyValues, ErrorType errorType, std::string_view message) = 0;
};
