...
# RCMS Attribute Properties

This package defines attribute properties of RCMS attributes.

**Dependencies**

!*/

package ext.rcms.properties;

import core.properties.*;

/*!

Depending on the attribute property type, the RCMS module uses either
attribute property types that are defined in the NDS.Live Core module or attribute
property types that are locally defined in the RCMS module.

!*/

/** Defines which attribute property type is used. */
struct RcmsPropertyType
{
  /**
...
/**
  ...
  */
struct RcmsPropertyValue(RcmsPropertyType type)
{
