...
# Localization Attribute Properties

This package defines attribute properties of localization attributes.

**Dependencies**

!*/

package localization.properties;

import core.properties.*;

/*!

Depending on the attribute property type, the features use either
attribute property types that are defined in the Core module or attribute
property types that are locally defined in this module.

!*/

/** Defines which attribute property type is used. */
struct LocalizationPropertyType
{
  /**
...
/**
  ...
  */
struct LocalizationPropertyValue(LocalizationPropertyType type)
{
